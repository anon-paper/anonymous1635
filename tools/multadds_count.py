...
def comp_multadds(model, input_data=None, input_size=(3,224,224), half=False, chosen_max=False):
    ...
    with torch.no_grad():
        _ = model(input_data, chosen_max) if chosen_max else model(input_data)
